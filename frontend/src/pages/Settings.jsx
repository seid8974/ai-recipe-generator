...
import { User, Lock, Trash2, Save, Moon, Sun, Flame } from 'lucide-react';
...
const Settings = () => {
    ...
    const { darkMode, setDarkMode, calorieGoal, updateCalorieGoal } = useTheme();
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="space-y-6">
                    ...
                    {/* App Preferences — Dark Mode & Calorie Goal */}
                    <div className="bg-white rounded-xl border border-gray-200 p-6">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">{darkMode ? 'Currently dark' : 'Currently light'}</p>
                                    </div>
                                </div>
                                <button
                            ...
                            <div>
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <div>
                                        <p className="font-medium text-gray-900">Daily Calorie Goal</p>
                                        <p className="text-sm text-gray-500">Shown as progress on your dashboard</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex items-center gap-1 min-w-[90px]">
                                        <input
                                            ...
                                            value={calorieGoal}
                                            onChange={(e) => updateCalorieGoal(e.target.value)}
                                            className="w-20 px-2 py-1 border border-gray-300 rounded-lg text-sm text-center outline-none focus:ring-2 focus:ring-orange-400"
                                        />
